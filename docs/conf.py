...
exclude_patterns = ['_build', '.github', '_work', 'generate', 'README.md', 'docs/releases', 'test/self-hosted-runner/output', 'test/self-hosted-runner/provision', 'test/self-hosted-runner/runner', 'TODO.md', 'test/e2e/README.md']
